...
namespace UserService.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, RoleManager<ApplicationUserRole> roleManager, IConfiguration configuration, SignInManager<ApplicationUser> signInManager, ITokenService tokenService, IUserRepository userRepository)
        {
